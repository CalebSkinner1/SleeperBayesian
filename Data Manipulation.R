...
projections_list <- list(
  ...
  list("josh hart",c(21.34, 22.36, 22.17, 22.49, 24.52, 23.66, 24.43, 23.63, 23.33, 22.34, 24.35, 24.24, 23.13, 25.9, 24.43, 24)),
  list("brunson",c(25.12, 25.32, 24.29, 24.86, 25.92, 25.47, 27.95, 27.22, 26.44, 25.09, 26.73, 27.68, 24.98, 26.75, 25.46, 26.82)),
  list("coby white",c(19.52, 20.71, 20, 19.91, 19.78, 19.82, 22.04, 20.57, 19.71, 20.27, 20.16, 20.01, 21.02, 19.87, 20.11, 19.53, 20.21, 22.14)),
  list("john collins",c(20.41, 14.49, 15.28, 16.28, 19.94, 20.17, 17.83, 17.57, 17.4, 21.98, 24.38, 25.6, 22.54, 24.85, 23.72, 21.55)),
  list("tobias harris",c(21.94, 22.32, 21.65, 21.19, 22.75, 22.41, 22.33, 22.49, 21.6, 22.91, 23.04, 21.28, 21.8, 22.48, 23.13, 22.61, 21.57, 19.91)),
  list("derrick white",c(19.25, 21.79, 20.49, 24.17, 21.7, 21.66, 22.85, 22.95, 22.37, 22.26, 22.66, 23.41, 21.21, 24.47, 21.37, 23.71, 21.84)),
  list("siakam",c(23.57, 22.21, 22.03, 21.71, 23.04, 22.72, 24.28, 23.75, 26.58, 23.16, 21.62, 24.45, 22.99, 26.06, 22.03, 22.74, 23.69)),
  list("adebayo",c(25.06, 26.13, 27.21, 25.45, 27.26, 25.76, 25.59, 27.88, 29.02, 29.85, 29.77, 31.12, 30.15, 30.24)),
  list("brook lopez",c(18.96, 21.86, 21.6, 19.92, 21.13, 19.66, 23.64, 21.98, 20.3, 19.91, 19.23, 23.05, 22.12, 20.41, 22.14, 21.47, 21.36)),
  list("tari eason",c(15.29, 10.06, 11.35, 11.79, 14.13, 13.4, 16.94, 17.62, 17.16, 18.61, 20.79, 18.63, 18.23, 19.02, 18.15, 19.82, 20.29, 18.26)))
